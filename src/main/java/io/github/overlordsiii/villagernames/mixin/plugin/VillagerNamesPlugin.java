package io.github.overlordsiii.villagernames.mixin.plugin;
...
public class VillagerNamesPlugin implements IMixinConfigPlugin {
	/**
	...
	public boolean shouldApplyMixin(String targetClassName, String mixinClassName) {
		return !mixinClassName.contains("mixin.guard.GuardEntityMixin") || FabricLoader.getInstance().isModLoaded("guardvillagers");
	}
